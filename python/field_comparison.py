...
from pyspark.sql.functions import col, round, count, mean, udf
...
if __name__=='__main__':
        ...
        df2 = df2.select([col(A).alias(A.lower()) for A in df2.columns])
        ...
        df.select(*[mean(col(A))\
                .alias(A) for A in df.columns])\
                .toPandas()\
...
# e.g. spark-submit python/field_comparison.py data/pluto_17v11.csv data/pluto_18v1.csv p1718.csv